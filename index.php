...
<!--/featured-->
<div id="gallery">
  <h3 class="title-brown">Building more than just houses...building hope</h3>
  <ul>
    <?php 	  	
...
<div id="quickviews">
  <div class="box">
    ...
    <div class="inner-box">
      <ul>
      <?php 	  	
	  	$query = new WP_Query( 'cat=6&posts_per_page=4' );
	  ?>
      <?php if ($query->have_posts()) : ?>
               <?php while ($query->have_posts()) : $query->the_post(); ?>   
      ...
      <a href="<?php bloginfo('url'); ?>/category/highlights/" class="morebycats">More Highlight &raquo;</a> 
  </div>
  </div>
  <div class="box">
