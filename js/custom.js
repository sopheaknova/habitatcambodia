...
$("#quickviews div:last-child, .c2 ul li:last-child, .c1 div.one_half:last-child").addClass("last");
});
...
/***************************************************
	     ADDITIONAL CODE FOR PRETTY PHOTO
***************************************************/
jQuery(document).ready(function($){
	$("#gallery:first a[rel^='prettyPhoto'], .c1:first a[rel^='prettyPhoto']").prettyPhoto({animationSpeed:'slow',theme:'light_rounded', slideshow:2000, autoplay_slideshow: false});
});
...
jQuery(document).ready(function($){
	...
	Cufon.replace('h3.title-brown', {
			hover: false, fontFamily: 'Serena'});
});	

/***************************************************
	     ADDITIONAL CODE FOR SHORTCODE
***************************************************/
jQuery(document).ready(function($){
	//toggle
